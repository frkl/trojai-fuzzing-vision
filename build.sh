...
sudo singularity build test-trojai-r10-search-v1.simg trojan_detector.def 


singularity run --nv -B ../trojai-datasets:/data/ test-trojai-r10-search-v1.simg  --model_filepath=/data/round10-train-dataset/models/id-00000003/model.pt  --result_filepath=./output.txt  --scratch_dirpath=./scratch/  --examples_dirpath=/data/round10-train-dataset/models/id-00000003/clean-example-data.json --source_dataset_dirpath /data/coco2017/trojai_coco/  --round_training_dataset_dirpath=/path/to/training/dataset/  --metaparameters_filepath=/metaparameters.json  --schema_filepath=/metaparameters_schema.json  --learned_parameters_dirpath=/learned_parameters
