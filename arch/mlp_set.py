...
class new(nn.Module):
    def __init__(self,params):
        ...
        nchkpt=1;
        nchkpt2=6;
        self.encoder_fv_color=encoder(nchkpt*51 ,nh2,nlayers);
        ...
        self.encoder_combined=MLP(nh+nh2,nh+nh2,2,nlayers2); #+46
    ...
    def forward(self,data_batch):
        ...
        if not isinstance(data_batch['flip_loss'],list):
            data_batch_exp={};
        ...
        for i in range(b):
            ...
            fv_color=fv_color.view(1,nclasses*nrounds,1*51);
            fv_color=self.encoder_fv_color(fv_color).mean(0);
            
            #Encode the polygon features
            ...
            fv=torch.cat((fv_color,fv_trigger),dim=0);
            h.append(fv);
