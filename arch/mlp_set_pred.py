...
class new(nn.Module):
    def __init__(self,params):
        ...
        self.encoder_hist=MLP(100,nh,nh,nlayers);
        self.encoder_combined=MLP(3*nh,nh3,2,nlayers2);
    ...
    def forward(self,data_batch):
        ...
        h=self.encoder_hist(weight_dist.cuda());
        h=torch.cat((h.mean(dim=1),h.max(dim=1)[0],h.min(dim=1)[0],),dim=-1);
